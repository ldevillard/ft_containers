...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/10/19 15:09:42 by ldevilla          #+#    #+#             */
/*   Updated: 2021/10/19 17:26:37 by ldevilla         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
void map_capacity()
{
	...
	std::cout << PURPLE << "max_size : " << tab.max_size() << "  - ft" << std::endl;
	std::cout << GREEN << "max_size : " << tab2.max_size() << "  - std" << std::endl;
